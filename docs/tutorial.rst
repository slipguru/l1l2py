...
(:file:`L1L2Py-1.0.1/docs/tutorial/dataset_generation.py`),
...
:file:`L1L2py-1.0.1/docs/tutorial`), where the script itself is located.
...
(:file:`L1L2py-1.0.1/docs/tutorial/plot.py`), provides
