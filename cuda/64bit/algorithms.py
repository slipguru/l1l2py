    ...
    for tau in reversed(tau_range):
        ...
        if mu == 0.0 and nonzero >= n: # lasso saturation
            ...
            beta_next, k= l1l2_regularization(data, labels, mu, tau, beta,
                                            kmax, tolerance, adaptive=adaptive, return_iterations = True)
            
            print("K final (python) = {}".format(k))
...
def l1l2_regularization(data, labels, mu, tau, beta=None, kmax=100000,
    ...
    # print(type(max_diff / max_coef))
    # print(type(max_diff))
    # print(type(max_coef))

    # print("K final (Pythonm inside l1l2) = {}".format(k))
